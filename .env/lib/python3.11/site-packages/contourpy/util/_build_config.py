...
def build_config() -> dict[str, str]:
    ...
    return dict(
        ...
        python_path=r"/home/pi/virtual1/bin/python",
        ...
        # Misc meson settings
        meson_backend="ninja",
        build_dir=r"/tmp/pip-install-h_8pvbqo/contourpy_d749a7370abd4b1293bd94800ab81f7f/.mesonpy-x9q16w4x/lib/contourpy/util",
        source_dir=r"/tmp/pip-install-h_8pvbqo/contourpy_d749a7370abd4b1293bd94800ab81f7f/lib/contourpy/util",
        cross_build="False",

        # Build options
        build_options=r"-Dbuildtype=release -Db_ndebug=if-release -Db_vscrt=md -Dvsenv=True --native-file=/tmp/pip-install-h_8pvbqo/contourpy_d749a7370abd4b1293bd94800ab81f7f/.mesonpy-x9q16w4x/meson-python-native-file.ini",
        buildtype="release",
        cpp_std="c++17",
        debug="False",
        optimization="3",
